...
0
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1500451947, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/qu_design', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1500451947, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/qu_design', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_nav.htm', 1500451947, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/qu_design', 'portal/portalcp_portalblock')
