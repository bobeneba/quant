<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><div class="ainuo_pt cl" style="border-bottom:1px solid #e2e2e2;">
<?php if(empty($gid) && $announcements) { ?>
<div class="y" style="max-width:526px;">
<div id="an">
<dl class="cl">
...
<div class="ainuo_bbsTop cl">
<div class="bbsTop_left cl">
    	<!--[diy=ainuo_bbsdiy1]--><div id="ainuo_bbsdiy1" class="area"></div><!--[/diy]-->
    </div>
    <div class="bbsTop_right cl">
    	<!--[diy=ainuo_bbsdiy2]--><div id="ainuo_bbsdiy2" class="area"></div><!--[/diy]-->
    </div>
</div>
<!--[diy=ainuo_bbsdiy3]--><div id="ainuo_bbsdiy3" class="area"></div><!--[/diy]-->
...
<?php if($forum['description']) { ?><p style="color:#ff0000;overflow:hidden; height:20px;"><?php echo $forum['description'];?></p><?php } ?>
                                    <?php if(empty($forum['redirect'])) { ?><dd style="color:#999; margin-top:3px;"><em>主题: <?php echo dnumber($forum['threads']); ?></em>, <em>帖数: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></h2>
<?php if($forum['description']) { ?><p style="margin-top:3px; color:#ff0000;"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>子版块: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>版主: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
<?php if(empty($forum['redirect'])) { ?><span class="xi2"><?php echo dnumber($forum['threads']); ?></span><span class="xg1"> / <?php echo dnumber($forum['posts']); ?></span><?php } ?>
