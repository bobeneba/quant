...
0
|| checktplrefresh('./template/qu_design/common/header.htm', './template/default/common/header_common.htm', 1500451903, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/qu_design', 'common/header_home_magic')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/header_qmenu.htm', 1500451903, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/qu_design', 'common/header_home_magic')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/pubsearchform.htm', 1500451903, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/qu_design', 'common/header_home_magic')
;?>
