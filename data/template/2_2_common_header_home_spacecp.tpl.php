...
0
|| checktplrefresh('./template/qu_design/common/header.htm', './template/default/common/header_common.htm', 1500451982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/qu_design', 'common/header_home_spacecp')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/header_qmenu.htm', 1500451982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/qu_design', 'common/header_home_spacecp')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/pubsearchform.htm', 1500451982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/qu_design', 'common/header_home_spacecp')
;?>
