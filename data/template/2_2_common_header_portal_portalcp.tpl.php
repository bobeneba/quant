...
0
|| checktplrefresh('./template/qu_design/common/header.htm', './template/default/common/header_common.htm', 1500451947, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/qu_design', 'common/header_portal_portalcp')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/header_qmenu.htm', 1500451947, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/qu_design', 'common/header_portal_portalcp')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/pubsearchform.htm', 1500451947, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/qu_design', 'common/header_portal_portalcp')
;?>
...
<div class="wp">
<div class="z">
                	<?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?>
</div>
<div class="y">
                	
                <?php include template('common/header_userstatus'); ?><?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra2'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra2'];?><?php if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
...
<div class="wp"><?php $mnid = getcurrentnav();?><div id="ainuo_nv">
...
<?php } ?><?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?>
</div>
