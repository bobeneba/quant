...
0
|| checktplrefresh('./template/qu_design/common/header.htm', './template/default/common/header_common.htm', 1500451916, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/qu_design', 'common/header_home_task')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/header_qmenu.htm', 1500451916, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/qu_design', 'common/header_home_task')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/pubsearchform.htm', 1500451916, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/qu_design', 'common/header_home_task')
;?>
