...
0
|| checktplrefresh('./template/qu_design/common/header.htm', './template/default/common/header_common.htm', 1500451777, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/qu_design', 'common/header_forum_index')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/header_qmenu.htm', 1500451777, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/qu_design', 'common/header_forum_index')
|| checktplrefresh('./template/qu_design/common/header.htm', './template/qu_design/common/pubsearchform.htm', 1500451777, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/qu_design', 'common/header_forum_index')
;?>
